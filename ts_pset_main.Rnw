...
%\usepackage[paperwidth=145mm,paperheight=215mm,height=182mm,width=113mm,top=20mm,includefoot]{geometry} % размер страниц в УРСС
...
<<child='chapters/010_stationary.Rnw'>>=
@


<<child='chapters/030_garch_problems.Rnw'>>=
@


<<child='chapters/050_var_problems.Rnw'>>=
@


<<child='chapters/080_state_space.Rnw'>>=
@
