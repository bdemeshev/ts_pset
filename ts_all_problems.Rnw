...
\begin{question}Пусть $ F_{n} $ - последовательность чисел Фибоначчи. Упростите величину
...
\begin{question}Представьте процесс AR(1),
...
\begin{question}Представьте процесс MA(1),
...
\begin{question}Представьте процесс ARMA(1,1),
...
\begin{question} Рекурсивные коэффициенты 
\begin{enumerate}
...
\begin{solution}
$z_t$ стационарный, $x_t$ и $y_t$ коинтегрированы
\end{solution}
